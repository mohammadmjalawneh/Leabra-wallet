		...
		<div class="row-fluid">
			...
			<div id="table2" class="span6" >
				...
				<table style="">
					...
					<tr>
						<td><h3>Your name</h3></td><td><h3 style="text-transform:capitalize;">{{$user['0']['fname']."  ".$user['0']['lname']}}</h3></td>
					</tr>
					<tr >
						<td><h3>Your Phone</h3></td><td><h3 style="text-transform:capitalize;">{{'+'.$user['0']['con_code']."-".$user['0']['phone']}}</h3></td>
					</tr>
					<tr >
						<td><h3>Your Balance</h3></td>
						<td><h3 style="">{{"  ".$user['0']['balance']}}</h3></td>
					</tr>
					<tr >
						<td><h3>Your Currancy</h3></td>
						<td><h3>{{$user['0']['currency']}}</h3></td>
					</tr>
				</table>
			</div>
			<div class="span3"></div>
